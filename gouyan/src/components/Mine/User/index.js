		...
		return (
			<div className = "mine-user page-footer">
                ...
                <div className = "info-box">
                    <h3 className = "user-name animated rubberBand">FuckSkyKu</h3>
                    <p className = "user-signature animated tada">MDZz</p>
                    <button onClick={this.props.exit} className="animated rotateIn">Quit~</button>              
                </div>   
