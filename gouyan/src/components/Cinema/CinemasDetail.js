        ...
        return (
			...
			<div>
				<div className="cinemasdetail">
					...
					<div className="pic animated bounceInRight">
						<img src={cinema} alt=""/>
					</div>
					<ul className="animated bounceInLeft">
						<li className="row">
							<div className="icon col-xs-2 left animated rubberBand"><i className="fa fa-film"></i></div>
						...
						<li className="row">
							<div className="icon col-xs-2 left animated rubberBand"><i className="fa fa-map-marker"></i></div>
							<div className="box col-xs-10 right">{this.state.cinema.address}</div>
						</li>
						<li className="row">
							<div className="icon col-xs-2 left animated rubberBand"><i className="fa fa-phone"></i></div>
